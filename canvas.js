...
function init(){
	...
	init.paths = [
		...
		"shield", "pill_red", "controlsMute", "controlsUnmute",
	...
	audioTest = new Audio();
	audioTest.src = "assets/music.mp3";
}
...
function loop() {
	...
	context.drawImage(resources[game.muted ? "controlsMute" : "controlsUnmute"], 0, 0, resources["controlsMute"].width, resources["controlsMute"].height, canvas.width - 70, 20, 50, 50);
